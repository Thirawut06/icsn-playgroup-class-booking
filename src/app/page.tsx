  ...
  return (
    <div className="bg-[#f8fafc] min-h-screen">
      <div className="max-w-[480px] mx-auto bg-white min-h-screen shadow-sm flex flex-col relative overflow-hidden pb-10">
          ...
          <div className="space-y-4 px-1">
              ...
              <div className="flex items-center gap-4">
                ...
                <div className="text-left space-y-0.5">
                  <div className="flex items-center gap-2 -mt-0.5">
                    <span className="font-bold text-gray-800 text-[16px]">New Parent</span>
                  ...
                  <div className="font-semibold text-gray-500 text-[13px]">สมัครสมาชิกใหม่</div>
                </div>
              </div>
            ...
            >
              <div className="flex items-center gap-4">
                ...
                <div className="text-left space-y-0.5">
                  <div className="font-bold text-gray-800 text-[16px] -mt-0.5">Sign In</div>
                  <div className="font-semibold text-gray-500 text-[13px]">เข้าสู่ระบบเดิม</div>
                </div>
              </div>
              <div className="w-8 h-8 rounded-full bg-gray-50 flex items-center justify-center group-hover:bg-white group-hover:shadow-sm transition-all border border-transparent group-hover:border-gray-100">
        ...
        <div className="p-6 pt-6 border-t border-gray-100 flex items-center justify-between text-[11px] text-gray-400">
          <div>© ICSN Panda Playgroup</div>
          <Link
            href="/admin"
