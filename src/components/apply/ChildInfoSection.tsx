  ...
  return (
    <>
      <div className="border-b border-gray-100 pb-3 mt-8">
        ...
        <p className="text-sm text-gray-500 font-medium">ข้อมูลนักเรียน</p>
      </div>

      <div>
        <label className="block mb-1.5">
          <span className="text-base font-bold text-gray-800">Child&apos;s full name <span className="text-red-500">*</span></span>
          <span className="block text-sm text-gray-500 -mt-0.5">ชื่อ-นามสกุลนักเรียน</span>
        </label>
      ...
      <div>
        <label className="block mb-1.5">
          <span className="text-base font-bold text-gray-800">Child&apos;s nickname <span className="text-red-500">*</span></span>
          <span className="block text-sm text-gray-500 -mt-0.5">ชื่อเล่นนักเรียน</span>
        </label>
      ...
      {path === 'trial' && (
        <>
          <div>
            <label className="block mb-1.5">
              <span className="text-base font-bold text-gray-800">Allergy (if any)</span>
