...
export function LineSupportCard({ className = '' }: { className?: string }) {
  return (
    <div className={`mt-4 flex items-center justify-center gap-1.5 ${className}`}>
      <span className="text-[13px] font-medium text-muted-foreground">พบปัญหาการใช้งาน?</span>
      <a 
        href="https://line.me/R/ti/p/@792sitws" 
        target="_blank" 
        rel="noopener noreferrer"
        className="inline-flex items-center gap-1 text-[13px] font-bold text-[#00b900] hover:underline transition-colors"
      >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 64 64" className="w-4 h-4">
          <path d="M64 27.487c0-14.32-14.355-25.97-32-25.97S0 13.168 0 27.487c0 12.837 11.384 23.588 26.762 25.62 1.042.225 2.46.688 2.82 1.578.322.81.21 2.076.103 2.894l-.457 2.74c-.14.81-.643 3.164 2.772 1.725s18.428-10.852 25.143-18.58h-.001C61.78 38.38 64 33.218 64 27.487" fill="#00b900"/>
          <g fill="#fff">
