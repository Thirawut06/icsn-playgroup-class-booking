...
export function LanguageSwitcher() {
  ...
  return (
    ...
    >
      ...
      <img src={FLAGS[lang]} alt={lang} loading="lazy" width="40" height="27" className="w-4 h-auto rounded-[2px] object-cover" />
...
export function LanguageSwitcherLight() {
  ...
  return (
    ...
    >
      {/* eslint-disable-next-line @next/next/no-img-element */}
      <img src={FLAGS[lang]} alt={lang} loading="lazy" width="40" height="27" className="w-4 h-auto rounded-[2px] object-cover shadow-[0_0_2px_rgba(0,0,0,0.1)]" />
      <span>{LABELS[lang]}</span>
    </button>
  );
}
