-- Approve Slip RPC to fix read-then-write race conditions and ALAWYS create a new package instead of merging
-- Fixes the bug where top-ups were being merged into the Trial package.
...
BEGIN
    ...
    -- 4. ALWAYS Create a New Package for the top-up
    INSERT INTO packages (parent_id, type, credits_remaining, non_refundable)
    VALUES (v_parent_id, COALESCE(v_slip_package_id, 'purchase'), p_credits_to_add, false)
