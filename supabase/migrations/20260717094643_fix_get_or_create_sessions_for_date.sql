-- Fix: Prevent get_or_create_sessions_for_date from destructively deleting custom sessions and capacity edits
...
BEGIN
    ...
    -- This is still useful if we ever change logic, but ON CONFLICT DO NOTHING handles duplicates anyway.
