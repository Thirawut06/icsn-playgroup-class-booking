-- Migration: 20260722043000_fix_set_date_status_rpc.sql
-- Description: Fix set_date_status RPC to be robust, handle admin role checks safely, and avoid 400 errors.
...
BEGIN
    ...
    -- Inserting single-day or range records safely
