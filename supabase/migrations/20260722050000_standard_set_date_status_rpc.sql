-- Migration: 20260722050000_standard_set_date_status_rpc.sql
-- Description: Clean, standard, and robust set_date_status RPC without fragile auth check deadlocks.
